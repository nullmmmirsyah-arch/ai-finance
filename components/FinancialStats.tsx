  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
      <div className='bg-green-100 p-4 rounded-lg'>
        ...
        <p className='text-lg font-bold text-green-900'>Rp. {totalIncome?.toFixed(0)}</p>
      </div>
      <div className='bg-red-100 p-4 rounded-lg'>
        <h3 className='text-lg font-semibold text-red-800'>Total Expense</h3>
        <p className='text-lg font-bold text-red-900'>Rp. {totalExpense?.toFixed(0)}</p>
      </div>
      <div className='bg-blue-100 p-4 rounded-lg'>
        <h3 className='text-lg font-semibold text-blue-800'>Net Flow</h3>
        <p className='text-lg font-bold text-blue-900'>Rp. {netFlow?.toFixed(0)}</p>
      </div>
    </div>
  );
};
