      ...
      <section className='py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl mx-auto'>
            At AI Finance, we leverage cutting-edge artificial
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                  <div className='w-12 h-12 bg-gradient-to-br from-[var(--gradient-start)] via-[var(--gradient-mid)] to-[var(--gradient-end)] rounded-xl flex items-center justify-center shadow-lg mb-6'>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-[var(--gradient-mid)] via-[var(--gradient-end)] to-[var(--gradient-start)] rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'>✨</span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
            ...
            <div className='group relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1'>
              ...
              <div className='relative z-10'>
                <div className='w-12 h-12 bg-gradient-to-br from-[var(--gradient-end)] via-[var(--gradient-start)] to-[var(--gradient-mid)] rounded-xl flex items-center justify-center shadow-lg mb-6'>
                  <span className='text-white text-xl'>📊</span>
                </div>
                <h3 className='text-xl font-bold mb-4 text-gray-900 dark:text-gray-100'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
            <div className='space-y-6'>
              <p className='text-lg text-gray-600 dark:text-gray-400 leading-relaxed'>
                AI Finance was born from the vision of creating truly
              ...
              <div className='flex items-center gap-4 pt-4'>
                <div className='flex -space-x-2'>
                  <div className='w-10 h-10 bg-gradient-to-br from-[var(--gradient-start)] to-[var(--gradient-mid)] rounded-full border-2 border-white dark:border-gray-800'></div>
                  <div className='w-10 h-10 bg-gradient-to-br from-[var(--gradient-mid)] to-[var(--gradient-end)] rounded-full border-2 border-white dark:border-gray-800'></div>
                  <div className='w-10 h-10 bg-gradient-to-br from-[var(--gradient-end)] to-[var(--gradient-start)] rounded-full border-2 border-white dark:border-gray-800'></div>
                </div>
      ...
      <section className='py-20 px-8 bg-gradient-to-br from-gray-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900/20 relative overflow-hidden'>
        ...
        <div className='max-w-4xl mx-auto text-center relative z-10'>
          ...
          <p className='text-xl md:text-2xl mb-10 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed'>
            ...
            habits with AI Finance. Start your journey towards smarter
            budgeting today.
          </p>
          ...
          <div className='flex flex-col sm:flex-row gap-6 justify-center items-center'>
            <Link
              href='/sign-up'
              className='group relative overflow-hidden bg-gradient-to-r from-[var(--gradient-start)] via-[var(--gradient-mid)] to-[var(--gradient-end)] hover:from-[var(--gradient-start)] hover:via-[var(--gradient-mid)] hover:to-[var(--gradient-end)] text-white px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-3xl transition-all duration-200 transform hover:-translate-y-0.5'
            >
